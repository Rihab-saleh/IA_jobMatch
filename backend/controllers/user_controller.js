...
// Modifier la définition du chemin d'upload pour utiliser le dossier src/assets
const uploadDir = path.join(__dirname, "IA_job/job-match-main/src/assets")
...
// Remplacer la méthode uploadProfilePicture par cette version mise à jour
const uploadProfilePicture = async (req, res) => {
  processRequest(res, async () => {
    ...
    try {
      ...
      // Stocker uniquement le chemin relatif de l'image
...
// Mettre à jour la méthode deleteProfilePicture pour utiliser le nouveau chemin
...
const updateCertification = async (req, res) => {
  processRequest(res, async () => {
    ...
    const certification = await userService.updateCertification(targetUserId, certificationId, certificationData)
...
const updateLanguage = async (req, res) => {
  try {
    ...
    const updated = await Language.findOneAndUpdate({ _id: languageId, user: userId }, req.body, { new: true })
