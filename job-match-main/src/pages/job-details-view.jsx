  ...
  const toggleSaveJob = async () => {
    ...
    try {
      if (saved) {
        ...
        const deleteResponse = await fetch(`http://localhost:3001/api/jobs/saved/${user._id}/${savedJob._id}`, {
          method: "DELETE",
        })
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-50">
        <div className="max-w-md p-6 bg-white rounded-lg shadow-md text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-800 mb-2">No job to display</h2>
          <p className="text-gray-600 mb-6">We couldn't find details for this position.</p>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="p-6 border-b border-gray-200">
            <Button variant="ghost" onClick={() => navigate(-1)} className="gap-2 text-gray-600 hover:bg-gray-100">
              ...
              <div className="mb-8">
                ...
                <div className="flex flex-wrap gap-2">
                  {job.skills.map((skill, index) => (
                    <Badge key={index} className="bg-blue-100 text-blue-800 hover:bg-blue-200 text-sm py-1.5 px-3">
                      {skill}
                    </Badge>
                  ))}
                </div>
            ...
            <Card className="mb-8 border border-gray-200">
              <CardContent className="p-6">
                ...
                <div className="prose max-w-none text-gray-700">
                  {job.description ? (
                    <div className="whitespace-pre-line" dangerouslySetInnerHTML={{ __html: job.description }} />
                  ) : (
